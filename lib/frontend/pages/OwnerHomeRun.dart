...
class OwnerHomeRun extends StatefulWidget {
  const OwnerHomeRun({super.key});

  @override
  State<OwnerHomeRun> createState() => _OwnerHomeRunState();
}

class _OwnerHomeRunState extends State<OwnerHomeRun> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final SessionService _sessionService = SessionService.instance;
  final List<Widget> _ownerPages = const [
    OwnerHomePage(),
    PropertiesPage(),
    TenantsPage(),
    AnalyticsPage(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(index: _selectedIndex, children: _ownerPages),
